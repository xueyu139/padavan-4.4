...
#define DEF_WLAN_2G_SSID	BOARD_PID "ppp_%s"
#define DEF_WLAN_5G_SSID	BOARD_PID "ppp_5G_%s"
#define DEF_WLAN_2G_GSSID	BOARD_PID "_GUEST_%s"
#define DEF_WLAN_5G_GSSID	BOARD_PID "_GUEST_5G_%s"
#define DEF_WLAN_2G_PSK		"taoye123."
#define DEF_WLAN_5G_PSK		"taoye123."

#define DEF_ROOT_PASSWORD	"taoye123"
